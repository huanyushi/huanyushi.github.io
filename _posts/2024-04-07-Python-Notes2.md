...
print(type(-2),      # <class 'int'>
      ...
      type(3 + 1j),  # <class 'complex'>, 需要注意 + j是不合法的，需要使用 + 1j
...
print('尊敬的',user_name,'用户，您今年',user_age,'岁了。') 
```
还有其他的函数，如
